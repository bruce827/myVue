...
var NationLawsSchema = new mongoose.Schema({
    id: String,
    file_number: String,
    name: String,
    organization: String,
...
//每次在存储数据之前都会调用此方法
NationLawsSchema.pre('save', function (next) {
    if (this.isNew) {
        this.id = uuid.v1();
    }
...
var NationLaws = mongoose.model('NationLaws', NationLawsSchema);
// 数据初始化
